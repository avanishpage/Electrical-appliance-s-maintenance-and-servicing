...
//                 <td><Link to={`/update/${service.id}`}><button>Update</button></Link></td>
//                 <td>delete</td>
//               </tr>
//             ))}
//           </tbody>
...
//     axios.delete(`http://localhost:8080/service/${serviceId}/vendor/1/delete/`)
//       .then(response => {
//         console.log('Service deleted:', response.data);
//         fetchServicesData(); // Refresh data after deletion
//       })
//       .catch(error => {
...
import axios from "axios";
// import './VendorServices.css'; // Import your CSS file
import { Link } from "react-router-dom";
import './VenderServices.css'
