...
function AddService() {
    ...
    //     axios.put(`YOUR_BACKEND_API_URL/${id}`, { jobStatus: newStatus })
    //         .then(response => {
    //             fetchJobStatusData(); // Refresh data after update
    //         })
    //         .catch(error => {
    ...
    const addNewJobStatus = event => {
        ...
        axios.post(`http://localhost:8080/service/add/${vendor.id}`, formData)
            .then(response => {
                fetchJobStatusData(); // Refresh data after adding
                setFormData({
                    name: '',
                    description: '',
                    price: 0,
    ...
    return (
        ...
        //             </tr>
        //             <tr>
        //                 <td><button type="submit">Add Service</button></td>
        //                 <td></td>
        //             </tr>
        //         </table>
        //     </form>
